...
- [Whitepaper Overview](whitepaper/overview.md)
    ...
    - [Technical Requirements](whitepaper/requirements/requirements.md)
        - [High performance and efficiency](whitepaper/requirements/performance_efficiency.md)
        - [Fast app startup](whitepaper/requirements/fast_startup.md)
        - [Quick compilation](whitepaper/requirements/quick_compilation.md)
        - [Consistency and flexibility](whitepaper/requirements/consistency_flexibility.md)
        - [Platform policy compliance](whitepaper/requirements/compliance.md)
